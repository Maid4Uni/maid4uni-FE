...
import { Box, TextField, Button, Typography, FormControl, Select, MenuItem, Dialog, DialogTitle, DialogContent, DialogContentText, DialogActions } from '@mui/material';
...
const CreatePackage = () => {
    ...
    const formik = useFormik({
        ...
        validationSchema: Yup.object().shape({
            ...
            description: Yup.string().required("Thêm mô tả gói dịch vụ").min(10, "Mô tả nhiều hơn 10 kí tự"),
    ...
    document.addEventListener('selectionchange', (e) => {
        if (!window.getSelection().isRangeEmpty()) {
        ...
        return (
            <Box maxWidth="400px" mx="auto" p={3}>
                {successMessage && <Typography variant="subtitle1">{successMessage}</Typography>}
                <Typography variant="h4" mb={2}>Create Package</Typography>
                <Formik {...formik}>
                    <Form>
                        <TextField
                        ...
                        <Button onClick={handleSubmit} type="submit" disabled={formik.isSubmitting} variant="contained" color="primary">
                            Tạo
                        </Button>
                    </Form>
                </Formik>
