...
import { Typography, TextField, FormControl, InputLabel, Select, MenuItem, Button, TablePagination } from '@mui/material';
              ...
              data.slice(page * rowsPerPage, page * rowsPerPage + rowsPerPage)
                .map((packages, index) => (
                  ...
                  >
                    ...
                    <TableCell align="right"> {packages.serviceList.map((service, serviceIndex) => (
                    ...
                    <TableCell align="right">{packages.status}
                    </TableCell>
