        ...
        <div class="row g-5">
          ...
          <div class="col-lg-6 wow fadeIn" data-wow-delay="0.5s">
            ...
            <p>
              ...
              chúng tôi là: cung cấp một giải pháp đơn giản, đáng tin
          ...
          <div className="customer-benefits row justify-content-around" style={{marginTop:"30px"}}>
            <h2 className="mb-3 text-center">Quyền Lợi của Bạn Khi Đăng Ký Dịch Vụ</h2>
          </div>
          <div className="row">
            ...
            <div className="col-md-3 mb-3">
              <div className="benefit-item text-center">
                <img
                  ...
                  alt="Hình ảnh mô tả quyền lợi của khách hàng"
                  className="img-fluid"
                  style={{ width: "100%", maxWidth: "150px", height: "auto", marginBottom:"20px" }}
                />
